...
**⏰ 自然な会話リズム**
- しばらくあなたからの返事がないとミクから話しかけてくれます
- 複数端末使用時はあなたが最後に話しかけた端末から話しかけます
...
2. 「送信」ボタンをクリック
3. 初音ミクが声で返事をしてくれます
4. 画像を添付して送信することで、初音ミクに写真などを見せることができます（画像以外は非対応です）
...
- 「前に話した旅行の件、覚えてる？」
- 「昨日見せた写真のこと、どう思った？」
- ミクは過去の会話をちゃんと覚えていて、関連する話を思い出してくれます

**時間を意識した自然な会話**
- 朝なら「おはよう」と挨拶してくれます
- 夜には「お疲れさま」と労ってくれます
- 季節の話題（「桜が咲いたね」など）も自然に話してくれます
- 深夜なら体調を気遣ってくれることも

**写真を見せて一緒に楽しむ**
- 撮った写真を見せて感想を聞いてみましょう
- 複数の写真を見せて比較してもらうのも楽しいです
- 過去に見せた写真のことも覚えているので、後から話題にできます
